...
var
  ...
  var
    UserType: PType;
  begin
    // AItem.THandle - ïîëüçîâàòåëüñêèé òèï òåêóùåãî ýëåìåíòà, IHType - òåêóùèé òèï TItemHeader (ïî óìîë÷àíèþ - FDefaultValueType)
    // ItemType - òèï òåêóùåãî ýëåìåíòà, íàïðèìåð, â ñëó÷àå åñëè òåêóùèé ýëåìåíò - ôóíêöèÿ, ItemType = TFunction.ReturnType
        ...
        begin
          ...
          try
            ...
            if Assigned(Script) then Add(Result, Script)
              ...
              // Åñëè ó ïàðàìåòðà ôóíêöèè óêàçàí òèï òî òàêîé ïàðàìåòð ðàññìàòðèâàåòñÿ êàê âëîæåííîå âûðàæåíèå, ñîîòâåòñòâåííî ïàðàìåòð
              // (AItem.Text) ìîæåò ñîäåðæàòü èëè ÷èñëî áåç òèïà èëè ôóíêöèþ áåç òèïà èëè ñòðîêó èëè âëîæåííîå âûðàæåíèå
              if Data.TextType = ttNumber then Write(icNumber)
                ...
                // Åñëè Parameter = True, âûðàæåíèå ðàçäåëÿåòñÿ ïî FPData, ëþáîé TTextItem.FHandle ñâÿçàí ñ "÷óæîé" PFunctionData,
                // PTypeData â ðàçäåëåíèè âûðàæåíèÿ íå ó÷àñòâóåò
                if Parameter then
                begin
